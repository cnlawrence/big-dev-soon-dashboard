...
const data = {
  ...
  datasets: [
    {
      backgroundColor: [colors.blue["500"], colors.blue["300"]],
      data: [2804, 397],
    },
  ],
};
...
<template>
  <div class="border border-b-[.04em] border-black/[16%] rounded-lg py-5 px-5">
    <div class="flex flex-col">
      <div class="h-10 text-xl font-semibold">Registered Users</div>
      <div class="flex flex-col space-y-4">
        ...
        <div class="absolute text-center">
          ...
          <div class="text-black font-bold text-4xl">3,201</div>
          <div class="text-black/60 text-sm">Total Users</div>
        </div>
        <div class="flex">
          <div class="flex-auto ml-28">
            <div class="font-semibold">2,804</div>
            <div class="text-black/60">Premium Users</div>
          </div>
          <div class="mr-28">
            <div class="font-semibold">397</div>
            <div class="text-black/60">Basic Users</div>
          </div>
        </div>
      </div>
    </div>
